  ...
  try {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        saleUnits: req.body.saleUnits ? req.body.saleUnits.toString() : "pcs",
        pricePerUnit: req.body.pricePerUnit ? JSON.stringify(req.body.pricePerUnit) : null,
      },
      include: {
        category: true,
        supplier: true,
...
export const updateProduct = async (req: Request, res: Response) => {
  try {
    ...
    const product = await prisma.product.update({
      ...
      data: {
        ...req.body,
        saleUnits: req.body.saleUnits && Array.isArray(req.body.saleUnits) ? req.body.saleUnits.toString() : req.body.saleUnits,
        pricePerUnit: req.body.pricePerUnit && typeof req.body.pricePerUnit === 'object' ? JSON.stringify(req.body.pricePerUnit) : req.body.pricePerUnit,
      },
      include: {
        category: true,
        supplier: true,
